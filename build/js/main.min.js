...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modalOpenButton = document.querySelector('[data-open-modal]');
  if (modalOpenButton) {
  ...
  var _iterator = _createForOfIteratorHelper(accordionHeaders),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      element.addEventListener('click', function (evt) {
        var accordion = evt.target.closest('[data-accordion-header]');
  ...
  var phoneInputs = document.querySelectorAll('[data-phone-input]');
  ...
  try {
    var _loop = function _loop() {
      ...
      input.addEventListener('input', function () {
        ...
        var numberLength = PHONE_NUMBER_LENGTH;
        var result = '+';
  ...
  var consentInputs = document.querySelectorAll('[data-consent-input]');
  var _iterator3 = _createForOfIteratorHelper(consentInputs),
    _step3;
  try {
  ...
  var buttonToCollapse = document.querySelector('[data-button-to-collapse]');
  var textCollapsible = document.querySelector('[data-text-collapsible]');
  buttonToCollapse.classList.remove('is-hidden');
  textCollapsible.classList.add('is-hidden');
  buttonToCollapse.addEventListener('click', function () {
